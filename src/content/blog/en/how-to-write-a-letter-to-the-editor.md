...
I know I keep writing about Oppen and his letters, but I just can't help it. Today I was typing up my notes from his mid-60s letters, and remembered a pretty tremendous letter he wrote to [Lita Hornick](http://www.columbia.edu/cu/lweb/archival/collections/ldpd_4078552/index.html), then the managing editor of _Kulchur,_ in response to _Kulchur_'s decision to print "Soirées," a Felix Pollak poem he wrote lampooning Denise Levertov's "[Matins](http://www.poetryfoundation.org/poetrymagazine/poem/18025)." Levertov was, at the time, the poetry editor of _The Nation_.

<figure class="align-left"><img class="zemanta-img-inserted zemanta-img-configured" title="Portriat of Denise Levertov" src="http://upload.wikimedia.org/wikipedia/commons/9/99/Denise-levertov.jpg" alt="Portriat of Denise Levertov" width="768" height="512"><figcaption>Portriat of Denise Levertov (Photo credit: Wikipedia)</figcaption></figure>

I was particularly interested in this little literary spat because I've been a curator for the [FELIX reading series](http://felixreadingseries.wordpress.com/about/) I hadn't read Pollak's poem, and I wanted to see what the fuss was all about, so I went to Special Collections in the UW-Madison library, dug up the issue of _Kulchur_ (Vol. 18, summer 1965) it appeared in.

<figure class="align-none"><img title="Cover of Kulchur 18" src="http://cdn.realitystudio.org/images/bibliographic_bunker/kulchur/kulchur.18.jpg" alt="Cover of Kulchur 18" width="669" height="1024"><figcaption>Cover of Kulchur 18 (Summer 1965)</figcaption></figure>
...
Witness the rise of sites like [Undetweetable](http://undetweetable.com/) and [Politwhoops](http://politwoops.sunlightfoundation.com/) and the way that the web economy's drive for page views had [Gawkerized news content](http://www.niemanlab.org/2012/03/i-cant-stop-reading-this-analysis-of-gawkers-editorial-strategy/) and [journalistic standards](http://www.theatlantic.com/magazine/archive/2011/04/learning-to-love-the-shallow-divisive-unreliable-new-media/8415/2/?single_page=true). 
